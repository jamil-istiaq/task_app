            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        {!! Form::label('name', 'Company Name') !!}<span class="required">*</span>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        {!! Form::text('address', '', ['id' => 'edit_address', 'class' => 'form-control', 'required']) !!}
                    </div>

                    <div class="form-group col-sm-12">
                        {!! Form::label('phone', 'Phone') !!}<span class="required">*</span>
                        {!! Form::text('phone', '', ['id' => 'edit_phone', 'class' => 'form-control', 'required']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12">
