                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    {{-- <div class="row">
                                        ...
                                        @endcan
                                        <div class="@if(Auth::user()->can('manage_users')) col-6 @else col-7 offset-4 @endif">
                                ...
                                {{-- <table class="table table-responsive-sm table-striped table-bordered task-detail" id="task_table"></table> --}}
