...
@canany(['manage_types','manage_suppliers'])
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#">
        <i class="fa fa-cog nav-icon" aria-hidden="true"></i>&nbsp;&nbsp;Supplier
    </a>
    <ul class="nav-dropdown-items">
        {{-- @can('manage_types') --}}
            <li class="nav-item {{ Request::is('tags*') ? 'active' : '' }}">
                {{-- <a class="nav-link" href="{!! route('tags.index') !!}"> --}}
                    <i class="fa fa-tags nav-icon" aria-hidden="true"></i>&nbsp;&nbsp;Supplier Type
                </a>
            </li>
        {{-- @endcan
        @can('manage_suppliers') --}}
            <li class="nav-item {{ Request::is('activity-types*') ? 'active' : '' }}">
                {{-- <a class="nav-link" href="{!! route('activity-types.index') !!}"> --}}
                    <i class="fas fa-clipboard-list nav-icon" aria-hidden="true"></i>&nbsp;&nbsp;Supplier List
                </a>
            </li>
        {{-- @endcan --}}
    </ul>
